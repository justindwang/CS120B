...
unsigned char rows[8] = {0x10, 0x08, 0x04, 0x02, 0x01, 0x02, 0x04, 0x08};
...
int tick1(int state){
    ...
    switch(state){
        case ss1:
            rows[0] = 0x1F;
            rows[1] = 0x00; rows[2] = 0x1F; rows[3] = 0x00; rows[4] = 0x1F; rows[5] = 0x00;rows[6] = 0x1F; rows[7] = 0x000;
            break;
        case ss2:
            set_rows(rows, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04, 0x00, 0x04);
            break;
    }
    return state;
}
