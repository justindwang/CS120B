...
tests = [ {'description': 'PINA: 0x00 => PORTC: 0x0F',
    'steps': [ {'inputs': [('PINA',0x00)], 'iterations': 1 } ],
    'expected': [('PORTC',0x0F)],
    },
    {'description': 'PINA: 0x01 => PORTC: 0x0E',
    'steps': [ {'inputs': [('PINA',0x01)], 'iterations': 1 } ],
    'expected': [('PORTC',0x0E)],
    },
    {'description': 'PINA: 0x03 => PORTC: 0x0C',
    'steps': [ {'inputs': [('PINA',0x03)], 'iterations': 1 } ],
    'expected': [('PORTC',0x0C)],
    },
    {'description': 'PINA: 0x07 => PORTC: 0x08',
    ...
    {'description': 'PINA: 0x0A => PORTC: 0x05',
    'steps': [ {'inputs': [('PINA',0x0A)], 'iterations': 1 } ],
    'expected': [('PORTC',0x05)],
    },
    {'description': 'PINA: 0x0B => PORTC: 0x04',
